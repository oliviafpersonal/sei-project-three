const pubSeed = [
  ...
  {
    nameOfPub: 'Be At One Cardiff',
    address: {
      line1: '60-62 St Mary St',
      line2: '',
      town: '',
      city: 'Cardiff',
      postCode: 'CF10 1FE'
    },
    description: 'Lively chain bar that serves sweet, sour and spicy cocktails, and offers mixing masterclasses.',
    isOutsideSeating: false,
    isPetFriendly: false,
    isFoodServed: false,
    isLiveSports: false,
...

{
    ...
    description: 'This bar and restaurant specialises in the experiential with a cocktail menu second to none. Try the infamous sharing cocktail ‘The Mad Hatters’ which features mind bending science.',
    isOutsideSeating: true,
    isPetFriendly: false,
    isFoodServed: true,
    isLiveSports: false,
    image: 'https://solicitingflavours.files.wordpress.com/2018/10/20181018_200718.jpg'
  },

  {
    nameOfPub: 'The Dead Canary',
    address: {
      line1: 'Barrack Ln',
      line2: '',
      town: '',
    ...
    description: 'Eclectic cocktails are freshly prepared at this designer bar with a style harking back to the 1920s.',
    isOutsideSeating: false,
    isPetFriendly: false,
    isFoodServed: false,
    isLiveSports: false,
    image: 'https://www.top50cocktailbars.com/wp-content/uploads/2018/05/image1-2.jpg'
  },

  {
    nameOfPub: 'Pennyroyal',
    address: {
      line1: '22 High St',
      line2: ' ',
      town: '',
    ...
    description: 'Pennyroyal is your friendly, neighbourhood Cocktail Bar, situated in the heart of Cardiff. They’re well known for their bold, eccentric cocktails and carefully curated spirits.',
    isOutsideSeating: false,
    isPetFriendly: false,
    isFoodServed: false,
    isLiveSports: false,
    image: 'https://media-cdn.tripadvisor.com/media/photo-m/1280/19/0d/4c/82/pennyroyal.jpg'
  },

  {
    nameOfPub: 'The Coconut Tree',
    address: {
      line1: '10 Mill Ln',
      line2: '',
      town: '',
    ...
    description: 'A modern street style bar serving Sri Lankan street food and sweet and fiery cocktails.',
    isOutsideSeating: false,
    isPetFriendly: false,
    isFoodServed: true,
    isLiveSports: false,
    image: 'https://i2-prod.walesonline.co.uk/incoming/article16045998.ece/ALTERNATES/s615/0_ML_BRI041018coconut_002JPG.jpg'
  },

  {
    nameOfPub: 'The Potted Pig',
    address: {
      line1: '27 High St',
      line2: '',
      town: '',
...

  {
    ...
    description: 'Traditional pub with a big, kid-friendly beer garden offering comfort food & a wide range of ales.',
    isOutsideSeating: true,
    isPetFriendly: true,
    isFoodServed: true,
    isLiveSports: false,
    image: 'https://media-cdn.tripadvisor.com/media/photo-s/1a/21/31/a4/the-four-elms-cardiff.jpg'
  },

  {
    nameOfPub: 'St Canna\’s Ale House',
    address: {
      line1: '42 Llandaff Rd',
      line2: '',
      town: '',
      city: 'Cardiff',
      postCode: 'CF11 9NF'
    },
    description: 'Small, dog friendly pub with good reviews and cheap deals on drinks. Live music which features local artists/musicians.',
    isOutsideSeating: true,
    isPetFriendly: true,
    isFoodServed: true,
    isLiveSports: false,
    image: 'https://i2-prod.walesonline.co.uk/incoming/article12820755.ece/ALTERNATES/s615b/rbp_mai300317ale3805JPG.jpg'
  },

  {
    nameOfPub: 'The City Arms',
    address: {
      line1: '10-12 Quay St',
      line2: '',
      town: '',
    ...
    description: '1880s pub with a big real ale selection, near the Millennium Stadium and frequented by sports fans.',
    isOutsideSeating: true,
    isPetFriendly: false,
    isFoodServed: true,
    isLiveSports: true,
    image: 'https://www.sabrain.com/cms-assets/heroes/_shareFacebook/City-Arms-2.jpg'
  },

  {
    nameOfPub: 'The Cambrian Tap',
    address: {
      line1: '51 St Mary Street',
      line2: '',
      town: '',
      city: 'Cardiff',
      postCode: 'CF10 1AD'
    },
    description: 'This a Brains pub, but it specialises in Brains craft beer, as well as good bar snacks to go with it. Found on the former Kitty Flynn/’s site, this pub is the perfect city centre spot for a pint and a pork pie',
    isOutsideSeating: false,
    isPetFriendly: false,
    isFoodServed: true,
    isLiveSports: false,
    image: 'https://i.pinimg.com/originals/07/fb/44/07fb44fd24bf9c45b71c6eb29b89bb48.jpg'
  },

  {
    nameOfPub: 'The Grange',
    address: {
      line1: '134 Penarth Road',
      line2: '',
      town: '',
      city: 'Cardiff',
      postCode: 'CF11 6NJ'
    },
    description: 'Named the Cardiff pub of the year by Camra in 2019. Inside, there are plenty of older features that have been retained, giving this place the balance of a modern bar with great ales and the rustic feel of a proper boozer.',
    isOutsideSeating: false,
    isPetFriendly: false,
    isFoodServed: true,
    isLiveSports: false,
    image: 'https://i2-prod.walesonline.co.uk/incoming/article11943903.ece/ALTERNATES/s615b/grange.jpg'
  },

  {
    ...
    description: 'A refurbished boozer in Cathays, this pub has everything you need for a quality, boozy meet-up.',
    isOutsideSeating: true,
    isPetFriendly: true,
    isFoodServed: true,
    isLiveSports: false,
...

{
    ...
    description: 'The Ty Mawr has a beautiful outdoor seating area, along with a compost corner where they grow vegetables for some of their dishes.',
    isOutsideSeating: true,
    isPetFriendly: true,
    isFoodServed: true,
    isLiveSports: false,
    image: 'https://venues4hire.org/Photos/d1a55bacb4b741f2b8320db0112065fb.jpg'
  },

  {
    nameOfPub: 'The Flora',
    address: {
      line1: '136 Cathays Terrace',
      line2: '',
      town: '',
      city: 'Cardiff',
      postCode: 'CF24 4HY'
    },
    description: 'Vibrant wall art, quality ales, cocktails and good food, this Cathays pub is a favourite among students. The Victorian boozer has had a new lease of life in recent years, with a revamp marketed towards students and young professionals.',
    isOutsideSeating: false,
    isPetFriendly: false,
    isFoodServed: true,
    isLiveSports: false,
    image: 'https://media.thetab.com/blogs.dir/6/files/2016/04/1973429-fa949285.jpg'
  },

  {
    nameOfPub: 'The Packet',
    address: {
      line1: '95 Bute Street',
      line2: '',
      town: '',
      city: 'Cardiff',
      postCode: 'CF10 5AB'
    },
    description: 'A pub with stacks of history, The Packet first opened in 1864. And while it may be surrounded by new-build flats and the shops and bars of Mermaid Quay, it’s retained that Cardiff Docks vibe.',
    isOutsideSeating: false,
    isPetFriendly: false,
    isFoodServed: true,
    isLiveSports: false,
    image: 'https://i2-prod.walesonline.co.uk/incoming/article15522027.ece/ALTERNATES/s615b/0_rbp_mai160617pub1325JPG.jpg'
  },
